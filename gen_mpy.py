...
lv_mp_type = {
    ...
    'char **'                   : 'char **'                  ,
    'const char **'             : 'const char **'            ,
    '%s_obj_t *'% module_prefix : '%s_obj_t *'% module_prefix,
    'uint8_t'                   : 'uint8_t'                  ,
    'uint16_t'                  : 'uint16_t'                 ,
    'uint32_t'                  : 'uint32_t'                 ,
    'uint64_t'                  : 'uint64_t'                 ,
...
{{
    ...
    lv_mp_type[struct_name] = sanitized_struct_name
    lv_mp_type['%s *' % struct_name] = sanitized_struct_name
    lv_mp_type['const %s *' % struct_name] = sanitized_struct_name
...
def gen_callback_func(func, func_name = None):
    ...
    callback_metadata[func_name]['return_type'] = return_type
    print("""
/*
